...
4.  **Project Architecture:**
    ...
    *   The architecture is very similar to the Chatwoot `enterprise` edition approach, where our code (`beet-digital-apps`) overwrites and extends the functionality of the base codebase.
